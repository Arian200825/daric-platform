...
export const content: SiteContent = {
  ...
  gallery: {
    ...
    images: [
      { alt: "The shoreline at dawn", gradient: ["#33415a", "#e6e2d6"] },
      { alt: "Suite terrace", gradient: ["#4a3f5e", "#dfe4de"] },
      { alt: "The spa thermal pool", gradient: ["#2e4a4a", "#e6e2d6"] },
      { alt: "Rooftop bar at dusk", gradient: ["#5a4632", "#dfe4de"] },
      { alt: "Poolside cabanas", gradient: ["#3a4a63", "#e6e2d6"] },
      { alt: "Private dining", gradient: ["#42364a", "#dfe4de"] },
    ],
  },
