    ...
    <Section id="contact" className="bg-surface">
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
        <Reveal className="flex flex-col gap-6">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl">We&apos;re here to help</h2>
        ...
        <Reveal delay={0.1}>
          {status === "success" ? (
            <div className="flex h-full flex-col items-center justify-center gap-4 rounded-[var(--radius)] border border-border bg-background p-10 text-center">
